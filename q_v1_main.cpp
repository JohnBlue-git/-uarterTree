...
int main()
{
	...
	// initial tree
	QuadtreeNode* root = new QuadtreeNode(&points[0], zero, (float)100);
	QuadtreeNode* head = root;// address of the roor
	...
	QuadtreeNode* copy = new QuadtreeNode(*root);
	// show
	copy->show();
	// find
	...
	std::cout << "\n" << std::endl;
	// delete
	copy->QuadtreeNode::~QuadtreeNode();
	delete copy;
